...
const About = () => {
  ...
  const skills = [
    ...
    { icon: Palette, label: 'UI/UX Design', desc: 'Creating beautiful interfaces' },
    { icon: Globe, label: 'Web Performance', desc: 'Optimizing for speed & SEO' },
  ];
          ...
          <div>
            ...
            >
              <p>
                ...
                started with a curiosity for how things work on the internet, which evolved
                into a deep love for creating beautiful digital experiences.
              </p>
              <p>
            ...
            >
              {skills.map((skill, index) => (
                ...
                >
                  ...
                  <h4 className="font-semibold text-white mb-1">{skill.label}</h4>
